...
const pricingButtonClassName = "mt-auto";
...
export function PricingTiersGrid({ tiers }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div
        className="pricing-tiers-grid grid gap-4 overflow-visible py-3 lg:grid-cols-3"
        data-billing-period={billingPeriod}
      >
        {tiers.map((tier) => {
          const ctaVariant = tier.key === "worker" ? "accent" : "default";

          return (
            <div
              key={tier.key}
              className={cn(
                "pricing-card flex flex-col rounded-lg border p-5",
              ...
              <div className="pricing-card-content">
                ...
                {tier.key === "free" ? (
                  tier.isCurrent ? (
                    ...
                    <Button asChild className={pricingButtonClassName}>
                  ...
                  tier.isCurrent ? (
                    ...
                    <Button asChild variant={ctaVariant} className={pricingButtonClassName}>
